...
import { LayoutDashboard, Briefcase, Users, ClipboardList, MessageSquare, Menu, X, LogOut, Shield, Leaf, AlertTriangle, Heart } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/admin/donations', label: 'Donations', icon: <Heart className="h-5 w-5" /> },
